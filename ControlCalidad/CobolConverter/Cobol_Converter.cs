...
namespace CobolConverter
{
  public static class Cobol_Converter
  {
    private static String ExecuteCobol(String WS_Name, List<String> Parameters = null)
    {
      ...
      if (!Config.ValueConfig.PathWebServices.EndsWith("\\"))
      {
        Config.ValueConfig.PathWebServices += "\\";
      }

      _command = Config.ValueConfig.PathWebServices + WS_Name;
      _parametros = "";
      if (Parameters == null)
      {
      ...
      _cmd = Config.ValueConfig.Runtime + " " + _command + " " + Config.ValueConfig.PathDatos + " " + Usuario + " " + _parametros;
